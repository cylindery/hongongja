package sec02.exam02;   //파일 복사 성능 테스트. 메모리 버퍼 이용하기
...
public class NonBufferVsBufferExample {
    public static void main(String[] args) throws Exception {
        ...
        String targetFilePath1 = "/Users/wonjuxx/Documents/Temp/targetFile1.jpg";
        FileInputStream fis = new FileInputStream(originalFilePath1);
        FileOutputStream fos = new FileOutputStream(targetFilePath1);

        String originalFilePath2 = NonBufferVsBufferExample.class.getResource("originalFile2.jpg").getPath();
        String targetFilePath2 = "/Users/wonjuxx/Documents/Temp/targetFile2.jpg";
